...
def _row_to_episode(row: sa.Row) -> Episode:
    return Episode(
        ...
        ticker_recommendations_url=row.ticker_recommendations_url,
        ...
        ticker_recommendations_content=row.ticker_recommendations_content,
...
class PostgresEpisodeRepository(EpisodeRepository):
    ...
    def upsert(self, episode: Episode) -> Episode:
        ...
        values = dict(
            ...
            ticker_recommendations_url=episode.ticker_recommendations_url,
            ...
            ticker_recommendations_content=episode.ticker_recommendations_content,
