  ...
  <>
    ...
    <PageContent className="max-w-2xl">
      <div className="flex items-center justify-center gap-2 mb-6 pt-4">
        <span className="text-2xl font-semibold tracking-[-0.02em]">聯絡</span>
        <AppLogo size={28} />
      </div>
      <div className="bg-card border border-border rounded-md p-6 sm:p-8">
        <p className="text-base text-muted-foreground leading-[1.65] mb-5">
          我們重視每一位使用者的聲音。若您有任何產品建議、合作想法或使用疑問，歡迎隨時與我們聯繫。
        </p>
        <div className="flex items-center gap-2 text-xs text-muted-foreground mb-8 bg-muted px-3.5 py-2.5 rounded-md w-fit">
